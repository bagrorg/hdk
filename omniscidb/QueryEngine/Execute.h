...
class Executor : public StringDictionaryProxyProvider {
 ...
 private:
  ...
  std::unique_ptr<policy::ExecutionPolicy> getExecutionPolicyForTargets(const RelAlgExecutionUnit& ra_exe_unit, const ExecutorDeviceType requested_device_type);
